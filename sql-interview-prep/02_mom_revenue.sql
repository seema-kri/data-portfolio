...
--percentage change, rounded to the 2nd decimal point, and sorted 
--from the beginning of the year to the end of the year. The percentage 
--change column will be populated from the 2nd month forward and calculated 
...
select month,round((revenue-prev_revenue)*100/prev_revenue,2) as per_mom
from mom
order by month
